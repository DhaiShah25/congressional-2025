    ...
    return (
        <div className="grid sm:grid-cols-2">
            <main className="text-lg sm:w-[80ch] mx-auto p-2">
                ...
                <h2 className="text-3xl text-center p-2">Step 1: Measure and Order the Window</h2>
                <p>
                ...
                <h2 className="text-3xl text-center p-2">Step 2: Prepare the Opening</h2>
                <p>
                ...
                <h2 className="text-3xl text-center p-2">Step 3: Dry‑Fit, Shim, and Set the Window</h2>
                <p>
                ...
                <h2 className="text-3xl text-center p-2">Step 4: Fasten and Square</h2>
                <p>
                ...
                <h2 className="text-3xl text-center p-2">Step 5: Insulate and Seal</h2>
                <p>
                ...
                <h2 className="text-3xl text-center p-2">Step 6: Trim and Finish</h2>
                <p>
