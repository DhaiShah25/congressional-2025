export default function Gate() {
    return (
        <main className="text-lg">
            <h1 className="font-bold text-4xl text-center">How to Replace a Window (Insert/Retrofit)</h1>
            <p>
            ...
            <div class="note">
                If your home was built before 1978, paint may contain lead. Follow local guidance and use proper safety practices when disturbing painted surfaces.
            </div>
            ...
            <h2 className="text-3xl text-center">Step 1: Measure and Order the Window</h2>
            <p>
            ...
            <h2 className="text-3xl text-center">Step 2: Prepare the Opening</h2>
            <p>
            ...
            <h2 className="text-3xl text-center">Step 3: Dry‑Fit, Shim, and Set the Window</h2>
            <p>
            ...
            <h2 className="text-3xl text-center">Step 4: Fasten and Square</h2>
            <p>
            ...
            <h2 className="text-3xl text-center">Step 5: Insulate and Seal</h2>
            <p>
            ...
            <h2 className="text-3xl text-center">Step 6: Trim and Finish</h2>
            <p>
            ...
            <div class="image">
                <img src="/window_guide.avif" alt="Diagram of insert window replacement: measurements, shims at jambs and sill, screws through frame, foam insulation, and interior/exterior caulk lines" />
            </div>
        </main>
    );
}
